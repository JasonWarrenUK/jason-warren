...
export const kitchenGremlin: AuthoredProject = {
	...
	plainBlurb:
		"A recipe book that lives entirely on your own computer. Import your existing recipes, search by what's in the fridge, keep your photos and never worry about a subscription lapsing or a company shutting down.",
	description:
