...
export const sparker: AuthoredProject = {
	...
	plainBlurb:
		'A notebook for teachers who support children with special educational needs. Record what you observe day to day, and it points out patterns that keep appearing together.',
