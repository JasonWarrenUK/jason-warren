...
export const historia: AuthoredProject = {
	...
	plainBlurb:
		'An animated map of England between the Romans leaving and the Normans arriving. Drag a slider and watch the kingdoms grow, shrink and swallow each other.',
	description:
