...
export const iris: AuthoredProject = {
	...
	plainBlurb:
		"Training providers must send the government a report on every apprentice, in a format that changes every year. Rather than hard-coding the rules, Iris reads the government's own rulebook and builds its checks from that, so when the rules change, it adapts. Feed it a spreadsheet and it produces a correct report.",
	description:
