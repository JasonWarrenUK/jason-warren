...
- **M5 Drift Decoupling: Engine & Verbs** (one verb and one visuals task remaining): the config-driven engine/integration split; the unbuilt verb backlog lands inside the decoupled design.
