...
export const thoseWhoCameBefore: AuthoredProject = {
	...
	plainBlurb:
		'A game about archaeology where the real subject is you. You dig up strange objects and decide what they were for; from then on, everything new is shown to you through what you already believe. The game never lies. It just makes it very easy to keep agreeing with yourself.',
	description:
