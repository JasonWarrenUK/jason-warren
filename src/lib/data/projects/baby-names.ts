...
export const babyNames: AuthoredProject = {
	...
	plainBlurb:
		'A baby-name finder that learns your taste. It suggests names, you say yes or no to each one, and its next suggestions get closer to what you actually like.',
	description:
