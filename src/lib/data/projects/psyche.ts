...
export const psyche: AuthoredProject = {
	...
	plainBlurb:
		'A role-playing game with no strength or health scores, only six personality traits like ambition and compassion. Every choice nudges one of them, and too much of any trait is as dangerous as too little.',
	description:
