...
export const codeArcana: AuthoredProject = {
	...
	plainBlurb:
		'The 78 tarot cards as a way into how to think while writing software. Each card is a short essay about one way of thinking, and every essay links to the others, so you follow your curiosity rather than a syllabus.',
	description:
