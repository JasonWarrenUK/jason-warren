...
export const nib: AuthoredProject = {
	...
	plainBlurb:
		'A small, reusable piece of code that lets interactive stories run inside a website. It was pulled out of one of my games so the next one would not have to start from scratch.',
	description:
