...
| **Drift**    | 2.5k-line CLI, manifest registry, cache, verbs, Bun migration, boundary doc, config layer, tag taxonomy (5DR.4), engine schema (5DR.5), engine/integration split (5DR.6), branch awareness + staging pipeline (5DR.7) | Audit verb (5DR.11), author/pin verbs (5DR.15/5DR.16), init scaffold (5DR.13) | Tests & docs (M6) blocked on M3 + M5; `init` (5DR.13) blocked on 5DR.7 — now unblocked; `hide` overlay (5DR.17) blocked on 5DR.16 |
