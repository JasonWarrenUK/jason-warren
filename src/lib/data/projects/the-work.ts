...
export const theWork: AuthoredProject = {
	...
	plainBlurb:
		'A story you play, set over one long night in a cold bedsit before a thesis defence. You turn the objects around you into ideas, and the ideas into an argument. Whether it holds up in the morning depends on how honest you were with yourself overnight.',
	description:
