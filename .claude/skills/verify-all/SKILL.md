---
name: 'Verify: All'
description: 'Verify both surfaces of this repo, the portfolio site and the Drift Engine, by running verify-portfolio and verify-cli in turn'
...
**Drift Engine** (`scripts/check-drift.js`). They're independent
