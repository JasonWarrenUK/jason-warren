...
export const redot: AuthoredProject = {
	...
	plainBlurb:
		'Software comes with explanatory notes that go stale the moment the code changes. ReDoT rewrites the notes automatically whenever someone changes the code they describe.',
	description:
