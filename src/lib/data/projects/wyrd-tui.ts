...
export const wyrdTui: AuthoredProject = {
	...
	plainBlurb:
		'A task manager built on the idea that tasks are never really a list. They block each other, belong to projects, wait on people. It stores them as a web of connections and lets you ask questions of that web, and it runs in a plain text window so it is fast and yours.',
	description:
