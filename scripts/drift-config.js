...
const DEFAULTS = {
	 ...
	 * Logical names: sources, topology, local, overrides, excluded, cache, projects, inProgress.
	 */
	files: {},
...
function buildConfig(user) {
	...
	const paths = {
		...
		topology: resolveDataPath(dataDirAbs, merged.files, 'topology', 'source-topology.json'),
